        ...
        <tr>
          ...
          <td align="center">
            <form name="formElimi{$r.id_proveedor}" method="post" action="proveedor_eliminar.php">
              <input type="hidden" name="id_proveedor" value="{$r.id_proveedor}">
              <a href="javascript:document.formElimi{$r.id_proveedor}.submit();" title="Eliminar Proveedor Sistema" onclick="javascript:return(confirm(' Desea realmente Eliminar a la Proveedor..?')); location.href='proveedor_eliminar.php'">
                Eliminar>>
              </a>
            </form>
          </td>
