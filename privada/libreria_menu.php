...
if ($nick != "") {
	echo"<div id='header'>
		...
		if ($cuerp == false) {
			echo"<a onclick='location.href=\"../claves/\"'><input type='button'name='accion' value='Cerrar Sesion' style='cursor:pointer;border-radius:5px;font-weight:bold;height: 30px;' class='boton_cerrar'></a>";
		}else{
			echo"<a onclick='location.href=\"claves/\"'><input type='button'name='accion' value='Cerrar Sesion'style='cursor:pointer;border-radius:5px;font-weight: bold;height: 30px;' class='boton_cerrar'></a>";
	}
	echo"</ul>
