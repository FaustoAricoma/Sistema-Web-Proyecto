...
<html>
  ...
  <body>
    ...
    <center>
      <table class="listado">
        <tr>
          <th>NRO</th><th>NOMBRE Y APELLIDO</th><th>DIRECCION</th><th>TELEFONO</th><th>NIT</th>
        ...
        <tr>
          ...
          <td align="center">
            <form name="formElimi{$r.id_cliente}" method="post" action="cliente_eliminar.php">
              <input type="hidden" name="id_cliente" value="{$r.id_cliente}">
              <a href="javascript:document.formElimi{$r.id_cliente}.submit();" title="Eliminar Cliente Sistema" onclick="javascript:return(confirm(' Desea realmente Eliminar a el Cliente..{$r.nombre}?')); location.href='persona_eliminar.php'">
                Eliminar>>
              </a>
            </form>
          </td>
