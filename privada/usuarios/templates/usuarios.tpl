  		...
  		<tr>
  			...
  			<td align="center">
  				<form name="formModif{$r.id_usuario}" method="post" action="usuario_modificar.php">
  					...
  					<a href="javascript:document.formModif{$r.id_usuario}.submit();" title="Modificar UsusioS">
  						Modificar>>
  					</a>
  				</form>
  			</td>
  			<td>
  				<form name="formElimi{$r.id_usuario}" method="post" action="usuario_eliminar.php">
  					<input type="hidden" name="id_usuario" value="{$r.id_usuario}">
  					<a href="javascript:document.formElimi{$r.id_usuario}.submit();" title="Eliminar Usuario" onclick='javascript:return(confirm(" Desea realmente Eliminar al usuario:::{$r.usuario}?"));'>
  						Eliminar
  					</a>
  				</form>
  			</td>
